...
ann_file = 'data/badminton/train_50.pkl'  
val_ann_file = 'data/badminton/val_50.pkl' 
test_ann_file = 'data/badminton/test_50.pkl'  
...
train_pipeline = [
    ...
    dict(type='UniformSample_order', clip_len=50, num_clips=1, p_interval=(1, 1)),  
...
work_dir = './work_dirs/shgcn/badminton/jm'       
