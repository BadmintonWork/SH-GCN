...
ann_file = 'data/shuttleset_match/train_100.pkl'  
val_ann_file = 'data/shuttleset_match/val_100.pkl'  
test_ann_file = 'data/shuttleset_match/test_100.pkl'  
...
work_dir = './work_dirs/shgcn/shuttleset_match/bm'       
